...
<div class="wrapper">
    ...
    <div id="sidebar">
        ...
        <ul class="list-unstyled component m-0">
            <li class="active" >
                <a href="#"><i class="material-icons">manage_accounts</i>Panel Administrador</a>
            </li>
            ...
            <li class="dropdown">
                <a href="Controlador?accion=listar">
                    <i class="material-icons">person_outline</i>Aprendices
                </a>
            </li>
            ...
            <li class="dropdown">
                <a href="ControladorNovedades?accion=listarNovedades">
